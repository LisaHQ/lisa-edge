...
if %ERRORLEVEL%==0 (
    ...
    echo   usb-installer\rescue\autoinstall\user-data
    echo   usb-installer\rescue\autoinstall\user-data.template
    echo.
...
:usage
echo Usage:
echo   usb-installer\rescue\prepare-ubuntu-rescue-usb.bat ^<usb-drive^>
echo.
echo Example:
echo   usb-installer\rescue\prepare-ubuntu-rescue-usb.bat E:
echo.
