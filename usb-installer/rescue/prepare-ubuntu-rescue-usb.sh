...
AUTOINSTALL_DIR="$SCRIPT_DIR/rescue/autoinstall"

usage() {
    cat <<'EOF'
Usage:
  sudo bash usb-installer/rescue/prepare-ubuntu-rescue-usb.sh <usb-mount-path>
...
Edit one of these files first:
  usb-installer/rescue/autoinstall/user-data
  usb-installer/rescue/autoinstall/user-data.template
