...
```text
install/usb/production/autoinstall/
```
...
```text
install/usb/rescue/autoinstall/
```
...
Prepare production USB files:

```bash
cd lisa-edge
sudo bash install/usb/production/scripts/prepare-ubuntu-usb.sh --auto-detect
```
